#
#  Be sure to run `pod spec lint LSApplication.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mister"
  # s.authors            = { "Mister" => "200739491@qq.com" }
  # s.social_media_url   = "http://twitter.com/Mister"
